...
namespace Практическая_работа__2 {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(string ФИО, string Отдел, string Должность, int Номер_телефона) {
...
namespace Практическая_работа__2.EmployeesDataSetTableAdapters {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Сотрудники` WHERE ((`Код` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `Отдел` IS NULL) OR (`Отдел` = ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)) AND ((? = 1 AND `Номер телефона` IS NULL) OR (`Номер телефона` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Сотрудники` (`ФИО`, `Отдел`, `Должность`, `Номер телефона`) VALUES (" +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Сотрудники` SET `ФИО` = ?, `Отдел` = ?, `Должность` = ?, `Номер телефона` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `Отдел` IS NULL) OR (`Отдел` = ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)) AND ((? = 1 AND `Номер телефона` IS NULL) OR (`Номер телефона` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Практическая_работа__2.Properties.Settings.Default.EmployeesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Код`, `ФИО`, `Отдел`, `Должность`, `Номер телефона` FROM `Сотрудники`";
        ...
        public virtual int Delete(int Original_Код, string Original_ФИО, string Original_Отдел, string Original_Должность, global::System.Nullable<int> Original_Номер_телефона) {
        ...
        public virtual int Insert(string ФИО, string Отдел, string Должность, global::System.Nullable<int> Номер_телефона) {
            if ((ФИО == null)) {
        ...
        public virtual int Update(string ФИО, string Отдел, string Должность, global::System.Nullable<int> Номер_телефона, int Original_Код, string Original_ФИО, string Original_Отдел, string Original_Должность, global::System.Nullable<int> Original_Номер_телефона) {
            if ((ФИО == null)) {
            ...
            if ((Original_Номер_телефона.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_Номер_телефона.Value));
            }
            else {
